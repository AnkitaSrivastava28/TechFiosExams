...
public class ToggleAllCheckBoxStep {
	...
	// connect with BrowserFactory to call the driver
		...
		public void user_is_already_in_techfios_test_page() throws Throwable {
			...
			ToggleAllCheckbox verifytitle= PageFactory.initElements(driver, ToggleAllCheckbox.class);
		...
		public void user_click_on_toggle_all_check_box() throws Throwable {
			ToggleAllCheckbox togglallcheckbox = PageFactory.initElements(driver, ToggleAllCheckbox.class);
		...
		public void close_the_browser() throws Throwable {
			ToggleAllCheckbox close= PageFactory.initElements(driver, ToggleAllCheckbox.class);
			//close.tearDown();
		}
